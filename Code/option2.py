...
if __name__ == '__main__':
    ...
    sfsort_layout = [
        [sg.Column([
            ...
            [
                sg.Text('Match TH First', size=(15, 1)), sg.InputText(default_text='0.24', key='match_th_first', size=(5, 1)),
                sg.Text('Match TH First M', size=(15, 1)), sg.InputText(default_text='0.05', key='match_th_first_m', size=(5, 1)),
                sg.Text('Match TH Second', size=(15, 1)), sg.InputText(default_text='0.1', key='match_th_second', size=(5, 1)),
            ],
            [
                sg.Text('Low TH', size=(15, 1)), sg.InputText(default_text='0.2', key='low_th', size=(5, 1)),
                sg.Text('New Track TH', size=(15, 1)), sg.InputText(default_text='0.85', key='new_track_th', size=(5, 1)),
